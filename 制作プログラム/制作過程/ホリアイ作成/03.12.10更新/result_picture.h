...
#define R_PICT_COUNT_POS		(D3DXVECTOR3(100.0f, 650.0f, 0.0f))				// カウントロゴ
#define R_PICT_COUNT_SIZE		(D3DXVECTOR2(80.0f, 50.0f))						
#define R_PICT_COUNT_MARK_POS_0	(D3DXVECTOR3(400.0f, 650.0f, 0.0f))
#define R_PICT_COUNT_MARK_POS_1	(D3DXVECTOR3(500.0f, 650.0f, 0.0f))
#define R_PICT_COUNT_MARK_POS_2	(D3DXVECTOR3(780.0f, 650.0f, 0.0f))
