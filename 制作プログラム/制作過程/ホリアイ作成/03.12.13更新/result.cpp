...
void CResult::Update(void)
{
	...
	{
		if (fade == CFade::FADE_NONE && CResultScore::GetShuffleCnt() > CResultScore::SCORETYPE_MAX - 1)
		{
		...
		if (CResultScore::GetShuffleCnt() < RESULT_SHUFFLE * (CResultScore::SCORETYPE_MAX - 1) && fade == CFade::FADE_NONE)
		{// カウントの短縮
			CResultScore::SetShuffleCnt(CResultScore::SCORETYPE_MAX - 1);
		}
	}
