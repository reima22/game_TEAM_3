...
bool CResultScore::m_bCntEventEnd[RESULT_SHFFLE_NUM] = {};
...
HRESULT CResultScore::Init(D3DXVECTOR3 pos)
{
	...
	// フラグのリセット
	for (int nCnt = 0; nCnt < RESULT_SHFFLE_NUM; nCnt++)
	{
...
void CResultScore::Update(void)
{
	...
	if (fade == CFade::FADE_NONE)
	{
		...
		if (m_nShuffleCnt >= 270 && m_bCntEventEnd[RESULT_SHFFLE_NUM - 1] == false)
		{// 約2秒
		...
		else if(m_nShuffleCnt < 270 && m_nShuffleCnt % 2 == 0 && m_nShuffleCnt >= 30)
		{
			// 0~99999999
