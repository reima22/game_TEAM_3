...
// マクロ定義
#define EXSCORE_TIMER_POS		(D3DXVECTOR3(580.0f, 400.0f, 0.0f))	// タイマー計算数列

#define EXSCORE_TIMERCALCU_POS	(D3DXVECTOR3(850.0f, 400.0f, 0.0f))	// タイマー計算結果数列

#define EXSCORE_COUNT_POS		(D3DXVECTOR3(580.0f, 600.0f, 0.0f))	// カウント計算数列

#define EXSCORE_COUNTCALCU_POS	(D3DXVECTOR3(850.0f, 600.0f, 0.0f))	// カウント計算結果数列
