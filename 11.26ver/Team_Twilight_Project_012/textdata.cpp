...
{
	{ "data/TEXT/StageObject/valley_objdata.txt" },		// 渓谷ステージオブジェクトデータ
	{ "data/TEXT/StageObject/sea_objdata.txt" },		// 海洋ステージオブジェクトデータ
	{ "data/TEXT/StageObject/lava_objdata.txt" },		// 溶岩ステージオブジェクトデータ
};
